...
namespace Fita_Oana_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Fita_Oana_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Fita_Oana_Lab8Context context,
